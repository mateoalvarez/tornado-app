...
INSERT INTO code_block_templates(template_name, model_engine, type, description, code_content)
VALUES ('linear_svc', 1, 'model', 'Spark Support Vector Machine. Configuración: {"maxIter":<número máximo de iteraciones>, "regParam":<valor del parámetro de regularización>}. Los valores por defecto son los siguientes: maxIter=100, regParam=0.0.', '{"code": "from pyspark.ml.classification import LinearSVC\nlsvc = LinearSVC(maxIter=100, regParam=0.0)\npipeline_models_stages.append((lsvc.uid, lsvc))\n", "params":"[<maxIter>,<regParam>]"}');
