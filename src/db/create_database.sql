...
INSERT INTO code_block_templates(template_name, model_engine, type, description, code_content)
VALUES ('decision_tree', 1, 'model', 'Spark decision tree. Configuración: {"maxDepth":<profundidad máxima del árbol>}. Los valores por defecto son los siguientes: maxDepth=10.', '{"code": "from pyspark.ml.classification import DecisionTreeClassifier\ndt = DecisionTreeClassifier(maxDepth=10, labelCol=\"label\")\npipeline_models_stages.append((dt.uid, dt))\n", "params":"[<maxDepth>,<labelCol>]"}');
