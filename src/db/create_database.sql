...
INSERT INTO code_block_templates(template_name, model_engine, type, description, code_content)
VALUES ('logistic_regression', 1, 'model', 'Spark logistic regression. Configuración: {"maxIter":<número máximo de iteraciones>, "regParam":<valor del parámetro de regularización>}', '{"code": "from pyspark.ml.classification import LogisticRegression\nlr = LogisticRegression(maxIter=10, regParam=0.001)\npipeline_models_stages.append((lr.uid, lr))\n", "params":"[<lr_max_iter>,<lr_reg_param>]"}');
